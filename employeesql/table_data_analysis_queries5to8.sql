...
-- and whose last name begins with letter 'B'
select e.first_name, e.last_name, e.sex
from employee as e
where first_name = 'Hercules'
and  upper(last_name) like 'B%'

-- 6. List each employee in the Sales department with their employee number,
...
-- 7. List each employee in the Sales and Development department with their 
